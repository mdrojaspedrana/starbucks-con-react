...
const Footer = () => {
  return (
    <footer className="footer">
        <div className="footer__container-usuario">
            <a className="footer__link-usuario" href="#">iniciar sesion</a>
            <a className="footer__link-usuario" href="#">registrate</a>
        </div>
        ...
        <div className="footer__container-contacto">
            <a className="footer__link-contacto" href="#">contactanos aqui</a>
        </div>
    </footer>
  )
}
